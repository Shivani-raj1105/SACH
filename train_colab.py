"""
train_colab.py: Google Colab compatible version of the training script
"""
...
def upload_files():
    ...
    print("[INFO] Please upload your project files (news_data.csv, feedback.csv, etc.)")
...
def main():
    try:
        print("[INFO] Setting up Google Colab environment...")
        ...
        args = TrainingArguments(
            "./bert-fake-news",
            per_device_train_batch_size=4,  # Increased for Colab GPU
            num_train_epochs=2,
            save_steps=100,
            save_total_limit=3,
            logging_steps=50,
